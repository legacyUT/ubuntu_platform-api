...
ANDROID_VERSION_MAJOR:=$(shell echo $(PLATFORM_VERSION) | cut -f 1 -d .)
ANDROID_VERSION_MINOR:=$(shell echo $(PLATFORM_VERSION) | cut -f 2 -d .)
LOCAL_CFLAGS += -DANDROID_VERSION_MAJOR=$(ANDROID_VERSION_MAJOR) -DANDROID_VERSION_MINOR=$(ANDROID_VERSION_MINOR)
